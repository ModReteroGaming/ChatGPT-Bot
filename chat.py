	...
	if chat_entry.get():
		...
		try:
			if os.path.isfile(filename):
				...
				# Display our question with our 'question' font settings
				my_text.insert(END, f"{chat_entry.get()}\n", 'question') 
				# Empty our question text box
				chat_entry.delete(0,END)
				# disply ChatGPT response
...
# Add Text WidgetTo Get ChatGPT Responses
...
# Create a light bluish-grey background, with lighter text to display our inquiry 
# before the ChatGPT response
my_text.tag_config('question', background="#536872", foreground="#abcfed")
